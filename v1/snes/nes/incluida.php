...
mysql_select_db("nes");
$sql="INSERT INTO noticias (id_noticias, titulo , mensagem2, emulador, url, mensagem, url2, mensagem3, id_usuario) VALUE";
$sql.="('null','$titulo',null',null',null','$mensagem'null',null','$id_usuario')";
